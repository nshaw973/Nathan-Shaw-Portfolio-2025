  ...
  return (
    <>
      ...
      {projectList.map((project, index) => {
        return (
          <div className={`flex flex-col w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-2 text-sm animate-fade animate-ease-out`}>
            ...
            <div className="w-full flex flex-col h-full">
              ...
              <p className="shadow-lg rounded-xl p-4 mt-2 min-h-64 bg-white">{project.about}</p>
