    ...
    <>
      <div className="flex flex-grow relative">
        ...
        <div className="bg-glass text-white text-xl absolute left-1/2 top-1/3 font-roboto w-fit">
          ...
          <h1 className="animate-fade-up animate-delay-[800ms] text-sm mt-2">
            Hello, and Welcome to my Porfolio!
          </h1>
          <Link
            to={"/about"}
            className="animate-fade animate-delay-[1700ms] btn rounded-xl btn-xs bg-slate-700 hover:bg-slate-900 text-white border-none flex ml-auto mr-4 w-fit mt-4"
          >
            Go to About
          </Link>
        </div>
